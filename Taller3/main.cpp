...
bool addData( TArbol& arbol, const std::string& nomArch )
{
  ...
  while( !entrada.eof( ) )
  {
    ...
    nuevaCacion.setID(id);
    nuevaCacion.setName(name);
    nuevaCacion.setGenre(genre);
    nuevaCacion.setArtist(artist);
    nuevaCacion.setAlbum(album);
    nuevaCacion.setPopularity(popularity);
    nuevaCacion.setDuration(duration);
    nuevaCacion.setExplicito(explicito);
   
    // TODO #17: Implementar la funciÃ³n insert en cada uno de los arboles
    arbol.insert( nuevaCacion );  // El arbol debe proveer el metodo "insert"
...
bool searchData( TArbol& arbol, const std::string& nomArch )
{
  ...
  while( !entrada.eof( ) )
  {
    ...
    // TODO #21: Implementar la funciÃ³n search en cada uno de los arboles
...
bool deleteData( TArbol& arbol, const std::string& nomArch )
{
  ...
  while( !entrada.eof( ) ){
    ...
    // TODO #23: Implementar la funciÃ³n delete en cada uno de los arboles
    ...
    std::set<Song>::iterator it;
      ...
      if(it->getID() == Id){
        arbol.erase(it);
        std::cout << "Se elimino el elemento con ID: " << Id << std::endl;
